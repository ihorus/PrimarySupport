				...
				<ul class="nav pull-right">
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
							<?php
							echo gravatarURL($_SESSION['currentUser']['uid']);
							?>
						<li><a href="node.php?n=user_unique&userUID=<?php echo $_SESSION['currentUser']['uid']; ?>">View Profile</a></li>
						<li><a href="node.php?m=user_profile/views/editUser.php&userUID=<?php echo $_SESSION['currentUser']['uid']; ?>">Change Settings</a></li>
						<li><a href="node.php?m=user_profile/views/editUser.php&userUID=<?php echo $_SESSION['currentUser']['uid']; ?>">Reset Password</a></li>
