...
$identicaUsername = UserSettings::get_setting($_SESSION['currentUser']['uid'], "identi.ca_username");
$identicaPassword = UserSettings::get_setting($_SESSION['currentUser']['uid'], "identi.ca_password");
