...
<?
$school = Group::find_by_uid($_SESSION[SITE_UNIQUE_KEY]['cUser']['schoolUID']);
$schools = Group::find_all();
$user = User::find_by_uid($_SESSION[SITE_UNIQUE_KEY]['cUser']['uid']);
...
<div class="span12">
	...
	<form class="form-horizontal" target="_self" method="POST" name="add_job" id="add_job">
		...
		<input name="school_uid" type="hidden" id="school_uid" value="<?php echo ($_SESSION[SITE_UNIQUE_KEY]['cUser']['schoolUID']); ?>">
