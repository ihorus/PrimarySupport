...
class User extends DatabaseObject {
	...
	public function gravatarURL($img = false, $defaultSize = 70) {
		...
		if ($img == true) {
			...
			$imageURL .= ("\" width=\"" . $defaultSize . "\" height=\"" . $defaultSize . "\" title=\"" . $this->firstname . "\" alt=\"" . $this->firstname ."\"/>");
